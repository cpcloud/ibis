...
FROM `anon_3`) AS `anon_2` UNION ALL SELECT `anon_4`.`string_col` AS `string_col`, `anon_4`.`metric` AS `metric` 
FROM `anon_4`) AS `anon_1` UNION DISTINCT SELECT `anon_5`.`string_col`, `anon_5`.`metric` 
FROM `anon_5`