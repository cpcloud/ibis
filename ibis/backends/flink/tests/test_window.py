...
import ibis
from ibis import _
from ibis.backends.tests.errors import Py4JJavaError, PyFlinkTableException


@pytest.mark.xfail(raises=PyFlinkTableException)
...
@pytest.mark.parametrize(
    ...
    [
        param(
            ...
            marks=[pytest.mark.xfail(raises=PyFlinkTableException)],
        ),
        param(
            {"rows": (-1, None)},
