...
@pytest.mark.parametrize(('case', 'expected'), [
    ...
    (api.interval(seconds=2).to_unit('ms'), api.interval(milliseconds=2 * 1000)),
    (api.interval(seconds=2).to_unit('us'), api.interval(microseconds=2 * 1000000)),
    (api.interval(seconds=2).to_unit('ns'), api.interval(nanoseconds=2 * 1000000000)),

    (api.interval(milliseconds=2).to_unit('ms'), api.interval(milliseconds=2)),
    (api.interval(milliseconds=2).to_unit('us'), api.interval(microseconds=2 * 1000)),
    (api.interval(milliseconds=2).to_unit('ns'), api.interval(nanoseconds=2 * 1000000)),

    (api.interval(microseconds=2).to_unit('us'), api.interval(microseconds=2)),
    (api.interval(microseconds=2).to_unit('ns'), api.interval(nanoseconds=2 * 1000)),
...
@pytest.mark.parametrize(('case', 'expected'), [
    ...
    (api.interval(hours=2).to_unit('ms'), api.interval(milliseconds=2 * 3600000)),
    (api.interval(hours=2).to_unit('us'), api.interval(microseconds=2 * 3600000000)),
    (api.interval(hours=2).to_unit('ns'), api.interval(nanoseconds=2 * 3600000000000))
])
...
@pytest.mark.parametrize(('case', 'expected'), [
    ...
    (api.interval(days=2).to_unit('ms'), api.interval(milliseconds=2 * 86400000)),
    (api.interval(days=2).to_unit('us'), api.interval(microseconds=2 * 86400000000)),
    (api.interval(days=2).to_unit('ns'), api.interval(nanoseconds=2 * 86400000000000)),
])
