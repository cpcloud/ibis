...
from .core import PythonToJavaScriptTranslator

__all__ = ('udf',)


_udf_name_cache = collections.defaultdict(
    itertools.count
...
def udf(
    ...
    def wrapper(f):
        ...
        udf_node = _create_udf_node(f.__name__, udf_node_fields)
...
def _create_udf_node(
    ...
    -------
    Type[BigQueryUDFNode]
        A new :class:`BigQueryUDFNode` subclass
