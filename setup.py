...
extras_require = {
    "all": [
        ...
        "clickhouse-sqlalchemy>=0.1,<0.2",
        "dask[dataframe,array]>2021.6.0",
        "geoalchemy2>=0.9,<0.10",
        "geopandas>=0.9,<0.10",
        "graphviz>=0.16,<0.17",
        "hdfs>=2,<3",
    ...
    "dask": ["dask[dataframe,array]>2021.6.0", "pyarrow>=5,<6"],
    "geospatial": [
        "geoalchemy2>=0.9,<0.10",
        "geopandas>=0.9,<0.10",
        "shapely>=1,<2",
    ...
    "kerberos": ["requests-kerberos>=0.12,<0.13"],
    "mysql": ["pymysql>=1,<2", "sqlalchemy>=1.3,<1.4"],
    "parquet": ["pyarrow>=5,<6"],
    "postgres": ["psycopg2>=2,<3", "sqlalchemy>=1.3,<1.4"],
    "pyspark": ["pyarrow>=5,<6", "pyspark>=3,<4"],
